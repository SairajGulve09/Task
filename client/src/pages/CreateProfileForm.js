    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Object.keys(profileData).forEach((key) => {
                if (key === 'socialMediaIds') {
                    Object.keys(profileData.socialMediaIds).forEach((socialKey) => {
                        formData.append(`socialMediaIds[${socialKey}]`, profileData.socialMediaIds[socialKey]);
                    });
                } else {
